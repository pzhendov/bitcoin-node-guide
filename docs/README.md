...
- [Sparrow and Bitcoin Core](sparrow-bitcoin-core.md) — restricted `rpcauth` bridge, protected credentials, connection verification and rollback for hardware-wallet preparation
